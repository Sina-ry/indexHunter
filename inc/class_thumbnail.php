...
class ImageGD
{
    ...
    public function cropThumbnailImage($width,$height){
        $imgsize1 = self::getImageSize($this->filename);
		$imgsize->width = $imgsize1['width'];
		$imgsize->height = $imgsize1['height'];
    ...
    public function readImage($filename){
        ...
        switch($extention){
            ...
            default : throw new Exception('i can\'t unserstand the image format');
        }
    return $image;
    }
