...
!(function (e, n, t) {
  ...
  function h(e, n, o, s) {
    ...
    for (var d, c, p, h, v, y = ['modernizr', 'tspan']; !P.style; )
      (d = !0), (P.modElem = i(y.shift())), (P.style = P.modElem.style);
  ...
  var _ = n.documentElement,
    ...
    x = 'Moz O ms Webkit',
    b = w._config.usePrefixes ? x.toLowerCase().split(' ') : [];
  w._domPrefixes = b;
  var E = w._config.usePrefixes ? x.split(' ') : [];
  w._cssomPrefixes = E;
