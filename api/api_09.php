...
$sql1 = " SELECT count(idx) as cntID FROM tc_board where b_gubun = '".$boGubun."' and b_custname = '". $uaddr."'  "	;
...
$sql1 = "select  * from  tc_board  where b_gubun = '02' and b_custname = '". $uaddr."'   "	;
if (strlen($shn) > 0 ) {	 	
	$sql1 = $sql1 . " and (b_title like  '%" . $shn . "%' or b_memo like '%" . $shn . "%' or b_custname like '%" .$shn. "%' ) " ; 	 	
}	
