...
if($mode == "insert") {
	...
	$aa = "qna.php?pg=" . $pg . "&spg=" . $spg . "&shn=" . $shn . "&mpage=". $mpage ."&spage=" .$spage. "&s_pagecnt=" . $s_pagecnt ;
	...
	//echo $sql1;
	$aa = "qna_write.php?mode=update&idx=" . $sidx . "&pg=" . $pg . "&spg=" . $spg . "&shn=" .$shn . "&mpage=". $mpage ."&spage=" .$spage."&s_pagecnt=" . $s_pagecnt ;
